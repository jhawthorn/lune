...
describe("Compiler", function()
  ...
  describe("return", function()
    it("can compile empty return", function()
      local lua = compile({{"ret", {}}})
      assert.are.same("return ", lua)
    end)

    it("can compile simple return", function()
      local lua = compile({{"ret", {{"number", "123"}}}})
      assert.are.same("return 123", lua)
    end)
  end)
end)
